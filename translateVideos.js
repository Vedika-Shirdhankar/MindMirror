const fs = require('fs');
let code = fs.readFileSync('src/pages/VideoMemories.jsx', 'utf8');

code = code.replace(/import \{ useState, useEffect, useRef \} from 'react'/, 'import { useState, useEffect, useRef } from \'react\'\nimport { useTranslation } from \'react-i18next\'');
code = code.replace(/export default function VideoMemories\(\) \{/, 'export default function VideoMemories() {\n  const { t } = useTranslation()');
...
fs.writeFileSync('src/pages/VideoMemories.jsx', code);
